...
![OPC UA TUI connect modal](docs/assets/connect-view.png)
![OPC UA TUI browser overview](docs/assets/browser-view.png)
![OPC UA TUI logging screen](docs/assets/logging-view.png)
